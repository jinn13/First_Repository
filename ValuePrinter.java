 ...
 * 네이밍 규칙
 * 1. 클래스명
 *  - 대문자로 시작, 여러 개의 단어가 있을 때는 단어 앞자리마다 대문자로 표기한다.(camel case/관습적으로 사용)
 * 2. 메소드명
 *  - 소문자로 시작, 여러 개의 단어가 있을 때는 단어 앞자리마다 대문자로 표기한다.(camel case/관습적으로 사용)
 * 3. 변수명
 * 
 *  
 */
